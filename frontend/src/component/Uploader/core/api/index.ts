...
// obsUploadCallback notifies the backend after the client completes an OBS
// multipart upload — without it the server never finalizes the session
// (cloudreve/frontend#344).
