...
var (
	...
	GiftCodesColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeEnum, Enums: []string{"points", "storage", "group", "traffic"}},
		{Name: "amount", Type: field.TypeInt64},
	...
	SkusColumns = []*schema.Column{
		...
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"mysql": "datetime"}},
		{Name: "name", Type: field.TypeString},
		{Name: "type", Type: field.TypeEnum, Enums: []string{"storage", "group", "traffic"}},
		{Name: "amount", Type: field.TypeInt64},
		{Name: "duration", Type: field.TypeInt64, Nullable: true},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "dl_traffic", Type: field.TypeInt64, Default: -1},
